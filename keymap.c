...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[3] = LAYOUT_preonic_1x2uL(KC_GRV, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_TAB, KC_EXLM, KC_AT, KC_EQL, KC_DLR, KC_AMPR, KC_CIRC, KC_LCBR, KC_RCBR, KC_DQUO, KC_LT, KC_DEL, KC_ESC, KC_PIPE, KC_BSLS, KC_UNDS, KC_MINS, KC_HASH, KC_ASTR, KC_LBRC, KC_RBRC, KC_QUOT, KC_GT, KC_QUOT, KC_LSFT, KC_LT, KC_QUOT, KC_DQUO, KC_PLUS, KC_QUES, KC_PERC, KC_LPRN, KC_RPRN, LSFT(KC_PGDN), LSFT(KC_PGUP), KC_ENT, KC_LCTL, KC_NO, KC_LALT, KC_LGUI, KC_NO, MO(6), KC_TRNS, KC_HOME, KC_PGDN, KC_PGUP, KC_END),
	...
	[5] = LAYOUT_preonic_1x2uL(KC_GRV, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_MUTE, KC_VOLD, KC_VOLU, KC_MPRV, KC_MPLY, KC_MNXT, KC_INS, KC_PSLS, KC_PMNS, KC_P7, KC_P8, KC_P9, KC_NO, KC_BRID, KC_BRIU, KC_NO, KC_NO, KC_NO, KC_DEL, KC_PAST, KC_PPLS, KC_P4, KC_P5, KC_P6, KC_LSFT, KC_NO, KC_CUT, KC_COPY, KC_PSTE, KC_NO, KC_PSCR, KC_PDOT, KC_P0, KC_P1, KC_P2, KC_P3, KC_LCTL, KC_TRNS, KC_LALT, KC_LGUI, KC_SPC, KC_NO, KC_NO, KC_HOME, KC_PGDN, KC_PGUP, KC_END),
